...
namespace GLFW.Net
{
    public static partial class GLFW
    {
        private static partial class Internal
        {
            ...
            public delegate void KeyCallback(IntPtr window, Key key, int scancode, KeyAction action,
                ModifierKey mods);
            ...
            public delegate void DropCallback(IntPtr window, int count, IntPtr paths);
